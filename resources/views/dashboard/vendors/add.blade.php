<x-dashboard.layouts.master title="{{__('dashboard.add vendor')}}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{__('dashboard.add vendor')}}">
                <li class="breadcrumb-item"><a href="{{route('admin.vendors.index')}}">{{__('dashboard.vendor list')}}</a></li>
            </x-dashboard.layouts.breadcrumb>
            <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{__('dashboard.add vendor')}}</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="POST" action="{{route('admin.vendors.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="contact-info-icon" class="form-control" value="{{old('description_ar')}}" name="description_ar" placeholder="{{__('dashboard.table description'). __('dashboard.in arabic')}}"/>
                                                        <div class="form-control-position">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="password-icon"  class="form-control" value="{{old('description_en')}}" name="" placeholder="{{__('dashboard.table description'). __('dashboard.in english')}}" autocomplete="off">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-pencil"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="number"  class="form-control" value="{{old('tax')}}" name="tax" placeholder="{{__('dashboard.table tax')}}">
                                                        <div class="form-control-position">
                                                            <i class="fa fa-usd"></i>
                                                        </div>
                                                    </div>
